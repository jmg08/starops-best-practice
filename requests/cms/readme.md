# CMS 请求示例 / CMS Request Examples

本目录包含 CMS SDK 的请求示例文件。
...
# 执行单个请求
go run ./cmd/chat-from-file/ -file ../../requests/cms/general_chat.json -simple

# 批量执行目录下所有请求
go run ./cmd/chat-from-file/ -dir ../../requests/cms -simple
```
